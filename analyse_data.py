...
class StockPredictor(object):
    def __init__(self, company, test_size=0.33, n_hidden_states=4, n_latency_days=10,
    ...
    def predict_close_prices_for_days(self, days, with_plot=False):
        ...
        if with_plot:
            ...
            plt.legend()
            plt.savefig('../result/gongshangyinhang.png')
            plt.show()
...
if __name__ == '__main__':
    ...
    stock_predictor = StockPredictor(company='gongshangyinhang')
